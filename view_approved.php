...
<head>
    ...
    <title>Print Approved Leave Application</title>
    <style>
        body { 
...
<div class="no-print" style="text-align: center; margin-top: 20px;">
        ...
        <div class="no-print" style="text-align: center; margin-top: 20px;">
            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'staff'): ?>
                <a href="staff.php" style="padding: 8px 15px; background: #007bff; color: white; text-decoration: none; border-radius: 4px;">Back to Dashboard</a>
            <?php elseif (isset($_SESSION['role']) && $_SESSION['role'] === 'hod'): ?>
                <a href="hod.php" style="padding: 8px 15px; background: #007bff; color: white; text-decoration: none; border-radius: 4px;">Back to Dashboard</a>
            <?php endif; ?>
        </div>
    </div>
</body>
